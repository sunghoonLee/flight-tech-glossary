---
title: "MiniRule_GetFromRec"
description: "Amadeus의 Mini Rule 조회 API인 MiniRuleGetFromRec의 기술 용어를 정리한 문서입니다."
---
...
<Info title="WBS Integration Flow Step 6">
이 API는 [WBS Integration Flow](/amadeus-wbs-integration-flow)의 **가격 조회 및 규정 확인 단계 Step 6**에 해당합니다.
</Info>
---
...
<CardGroup cols={2}>
  <Card title="WBS Integration Flow - Step 6" href="/amadeus-wbs-integration-flow" icon="link" />
  <Card title="Fare_CheckRules 용어집" href="/pricing/fare-check-rules" icon="link" />
