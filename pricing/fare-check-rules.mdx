---
title: "Fare_CheckRules"
description: "확정된 운임의 상세 운임 규정(Fare Rules)을 전문 텍스트로 조회하는 API 용어집입니다."
---
...
| 이전 단계 | [Fare_InformativePricingWithoutPNR](/pricing/fare-informative-pricing) |
| 다음 단계 | [MiniRule_GetFromRec](/pricing/minirule-get-from-rec) |
...
<Info title="WBS Integration Flow Step 5">
이 API는 [WBS Integration Flow](/amadeus-wbs-integration-flow)의 **가격 조회 및 규정 확인 단계 Step 5**에 해당합니다.
</Info>
---
...
<CardGroup cols={2}>
  <Card title="WBS Integration Flow - Step 5" href="/amadeus-wbs-integration-flow" icon="link" />
  <Card title="Fare_GetFareRules 용어집" href="/reference/fare-get-fare-rules" icon="link" />
  <Card title="MiniRule_GetFromRec 용어집" href="/pricing/minirule-get-from-rec" icon="link" />
