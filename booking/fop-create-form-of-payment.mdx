---
title: "FOP_CreateFormOfPayment"
description: "저장된 PNR에 결제 수단(Form of Payment)을 등록하는 API 용어집입니다."
---
...
<Info title="WBS Integration Flow Step 9">
이 API는 [WBS Integration Flow](/amadeus-wbs-integration-flow)의 **예약 생성 단계 Step 9**에 해당합니다.
</Info>
---
...
| 이전 단계 | [PNR_AddMultiElements](/booking/pnr-add-multi-elements) |
| 다음 단계 | [Fare_PricePNRWithBookingClass](/ticketing/fare-price-pnr-with-booking-class) |
...
<CardGroup cols={2}>
  <Card title="WBS Integration Flow - Step 9" href="/amadeus-wbs-integration-flow" icon="link" />
