---
title: "PNR_AddMultiElements (PNR 요소 추가/수정)"
description: "Amadeus PNRAddMultiElements API(버전 22.1)의 기술 용어를 정리한 문서입니다. PNR(Passenger Name Record)에 승객 이름, 여정, SSR, OSI, 발권 정보, Remarks, 결제 수단 등 PNR을 구성하는 거의 모든 요소를 생성하거나 수정하는 API입니다."
sidebarTitle: "PNR_AddMultiElements"
---
...
<Info title="WBS Integration Flow Step 8">
이 API는 [WBS Integration Flow](/amadeus-wbs-integration-flow)의 **예약 생성 단계 Step 8**에 해당합니다.
</Info>
---
...
| 이전 단계 | [Air_SellFromRecommendation](/booking/air-sell-from-recommendation) |
| 다음 단계 | [FOP_CreateFormOfPayment](/booking/fop-create-form-of-payment) |
...
<CardGroup cols={2}>
  <Card title="WBS Integration Flow - Step 8" href="/amadeus-wbs-integration-flow" icon="link" />
  <Card title="Air_SellFromRecommendation 용어집" href="/booking/air-sell-from-recommendation" icon="link" />
