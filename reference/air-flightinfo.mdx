---
title: "Air FlightInfo (항공편 정보 조회)"
description: "Amadeus AirFlightInfo API(버전 07.1)의 기술 용어를 정리한 문서입니다. 특정 항공편의 스케줄, 운항 정보, 좌석 가용성, 기내 서비스 등 상세 정보를 조회하는 API입니다."
sidebarTitle: "Air FlightInfo"
---
