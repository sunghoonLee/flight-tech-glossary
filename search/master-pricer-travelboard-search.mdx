---
title: "Master Pricer Travelboard Search (MPTBS)"
description: "Amadeus의 항공편 검색 및 운임 조회 API인 FareMasterPricerTravelBoardSearch의 기술 용어를 정리한 문서입니다."
sidebarTitle: "Master Pricer Travelboard Search"
---
...
<Info title="WBS Integration Flow Step 2">
이 API는 [WBS Integration Flow](/amadeus-wbs-integration-flow)의 **검색 단계 Step 2**에 해당합니다.
</Info>
---
...
| 이전 단계 | [Fare_MasterPricerCalendar](/search/fare-master-pricer-calendar) |
| 다음 단계 | [Fare_InformativeBestPricingWithoutPNR](/pricing/fare-informative-best-pricing) |
...
<CardGroup cols={2}>
  <Card title="WBS Integration Flow - Step 2" href="/amadeus-wbs-integration-flow" icon="link" />
  <Card title="Fare_MasterPricerCalendar 용어집" href="/search/fare-master-pricer-calendar" icon="link" />
  <Card title="Fare_InformativeBestPricingWithoutPNR 용어집" href="/pricing/fare-informative-best-pricing" icon="link" />
  <Card title="Fare_InformativePricingWithoutPNR 용어집" href="/pricing/fare-informative-pricing" icon="link" />
</CardGroup>
